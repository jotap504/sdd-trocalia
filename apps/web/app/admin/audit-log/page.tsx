      ...
      <Card>
        <CardBody className="py-20 text-center">
          <div className="relative inline-flex">
            <ShieldCheck
              size={56}
              className="text-trocalia-text-muted mx-auto"
            />
            <span className="absolute -bottom-1 -right-1 bg-amber-100 rounded-full p-1">
              <Clock size={18} className="text-amber-600" />
            </span>
          </div>
          <h2 className="font-heading font-bold text-lg text-trocalia-text mt-5">
            En construcción
          </h2>
          <p className="text-sm text-trocalia-text-muted mt-2 max-w-sm mx-auto">
